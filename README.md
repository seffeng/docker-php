...
$ docker run --name php-74-alias1 --network network-01 --network-alias php-74-net1 -d -v /srv/websrv/data/wwwroot:/opt/websrv/data/wwwroot -v /srv/websrv/tmp:/opt/websrv/tmp -v /srv/websrv/logs/php/7.4:/opt/websrv/logs seffeng/php:7.4
```
