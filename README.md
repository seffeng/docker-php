...
# 完整示例，可参考备注 ：
$ docker run --name php-71-alias1 -d -v /srv/websrv/data/wwwroot:/opt/websrv/data/wwwroot -v /srv/websrv/tmp:/opt/websrv/tmp -v /srv/websrv/logs/php/7.1:/opt/websrv/logs seffeng/php:7.1
